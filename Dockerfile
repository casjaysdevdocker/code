# Docker image for code using the alpine template
ARG IMAGE_NAME="code"
ARG PHP_SERVER="code"
...
ARG IMAGE_REPO="casjaysdevdocker/code"
...
ENV HOSTNAME="casjaysdevdocker-code"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/code"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/code"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.revision="${GIT_COMMIT}"
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/code"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/code"
